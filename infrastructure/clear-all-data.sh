...
REFERENCE_DATA_POSTGRES_DB="reference_data"
...
REFERENCE_DATA_POSTGRES_ROLE=${REFERENCE_DATA_POSTGRES_USER:-"events_reference_data"}
...
docker run --rm --network=$NETWORK  \
  ...
  -e REFERENCE_DATA_POSTGRES_ROLE="${REFERENCE_DATA_POSTGRES_ROLE}" \
  -e REFERENCE_DATA_POSTGRES_DB="${REFERENCE_DATA_POSTGRES_DB}" \

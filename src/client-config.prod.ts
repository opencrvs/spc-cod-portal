...
export default defineClientConfig({
  ...
  DASHBOARDS: [
    ...
    {
      id: 'export-coded-records',
      title: {
        id: 'dashboard.exportCodedRecordsTitle',
        defaultMessage: 'Export coded records',
        description: 'Menu item for exporting coded records dashboard'
      },
      url: `https://metabase.${env.DOMAIN}/public/dashboard/489f6cb0-ee8a-4ac5-ae7c-26bdb2f8f623#bordered=false&titled=false&refresh=300`
    }
  ],
  FEATURES: {}
})
